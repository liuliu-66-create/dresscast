---
name: tryon-video-generator
description: "虚拟试穿带货视频生成器。用户提供商品图（服装）和模特图，自动完成虚拟试穿融合 + 带货视频生成，结果写入飞书多维表格。触发方式：'试穿视频'、'虚拟试穿'、'生成试穿视频'、'衣服上身视频'、'带货视频'、'产品试穿宣传片'、'tryon video'、'virtual try-on'。使用阿里云百炼 wan2.7-image（图像融合）+ wan2.6-i2v-flash（有声视频）+ qwen3-vl-flash（图片分析）模型。"
---
